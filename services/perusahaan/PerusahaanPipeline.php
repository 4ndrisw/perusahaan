...
namespace modules\perusahaan\services\perusahaan;

use app\services\AbstractKanban;

class PerusahaanPipeline extends AbstractKanban
{
    ...
    {
        return get_option('default_perusahaan_pipeline_sort_type');
    }

    public function defaultSortColumn()
    {
        return get_option('default_perusahaan_pipeline_sort');
    }

    public function limit()
    {
        return get_option('perusahaan_pipeline_limit');
    }
