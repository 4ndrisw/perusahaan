...
<div class="modal fade" id="sales_item_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/perusahaan/jenis_pesawat/manage', ['id' => 'jenis_pesawat_form']); ?>
...
<script>
    // Maybe in modal? Eq convert to invoice or convert perusahaan to estimate/invoice
...
function init_item_js() {
    ...
    $("body").on('show.bs.modal', '#sales_item_modal', function (event) {
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('perusahaan/jenis_pesawat/get_item_by_id/' + id).done(function (response) {
