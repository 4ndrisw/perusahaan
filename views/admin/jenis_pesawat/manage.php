        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="_buttons tw-mb-2 sm:tw-mb-4 tw-inline-block tw-w-full">
                    ...
                    <a href="<?php echo admin_url('perusahaan/jenis_pesawat/import'); ?>" class="btn btn-primary pull-left mleft5">
...
$(function() {
    ...
    initDataTable('.table-invoice-items', admin_url + 'perusahaan/jenis_pesawat/table',
    ...
    $('body').on('click', '.update-item-group', function() {
        ...
        if (name != '') {
            $.post(admin_url + 'perusahaan/jenis_pesawat/update_group/' + group_id, {
                name: name
            }).done(function() {
                window.location.href = admin_url + 'perusahaan/jenis_pesawat';
            });
        }
    });
});
