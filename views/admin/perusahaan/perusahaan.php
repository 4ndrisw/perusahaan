                     ...
                     <div class="col-md-6 border-right">
                        ...
                        <div class="form-group select-placeholder">
                           ...
                           <select name="rel_type" id="rel_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                              <option value=""></option>
                              <option value="lead" <?php if((isset($perusahaan) && $perusahaan->rel_type == 'lead') || $this->input->get('rel_type')){if($rel_type == 'lead'){echo 'selected';}} ?>><?php echo _l('perusahaan_for_lead'); ?></option>
                             ...
                             <div class="col-md-6">
                               <div class="form-group select-placeholder">
                                 ...
                                 <select name="discount_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                  ...
                                  if(isset($perusahaan)){ if($perusahaan->discount_type == 'before_tax'){ echo 'selected'; }}?>><?php echo _l('discount_type_before_tax'); ?></option>
                                  <option value="after_tax" <?php if(isset($perusahaan)){if($perusahaan->discount_type == 'after_tax'){echo 'selected';}} ?>><?php echo _l('discount_type_after_tax'); ?></option>
                                </select>
                              </div>
                            </div>
                           </div>
                        ...
                        <div class="form-group mtop10 no-mbot">
                            ...
                            <div class="onoffswitch">
                              <input type="checkbox" id="allow_comments" class="onoffswitch-checkbox" <?php if((isset($perusahaan) && $perusahaan->allow_comments == 1) || !isset($perusahaan)){echo 'checked';}; ?> value="on" name="allow_comments">
                           ...
                           <div class="col-md-6">
                              <div class="form-group select-placeholder">
                                 ...
                                 <select name="status" class="selectpicker" data-width="100%" <?php echo $disabled; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    ...
                                    <option value="<?php echo $status; ?>" <?php if((isset($perusahaan) && $perusahaan->status == $status) || (!isset($perusahaan) && $status == 0)){echo 'selected';} ?>><?php echo format_perusahaan_status($status,'',false); ?></option>
                                    <?php } ?>
                                 </select>
                              </div>
                           </div>
